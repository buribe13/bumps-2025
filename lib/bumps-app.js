...
const SPOTIFY_CLIENT_ID =
  process.env.NEXT_PUBLIC_SPOTIFY_CLIENT_ID || "faf051d1e310436988ecdc54f79b7ac2";
...
Return ONLY valid JSON, no markdown, no code blocks, no explanations.`;
    ...
    if (!response.ok) {
      ...
      if (response.status === 401) {
        userMessage =
          "Invalid OpenAI API key. Set OPENAI_API_KEY in your Vercel project environment variables.";
